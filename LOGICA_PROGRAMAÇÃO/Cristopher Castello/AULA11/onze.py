...
btn_clicar_fechar.grid(row=2, column=2, padx=20, pady=20)
lbl_mensagem_pagina = tk.Label(janela, text="Você mandou muito nessa, boa!!!", font=("Arial", 20, "bold"))
...
lbl_mensagem_pagina.grid(padx=20)
# 5. Rodar interface 
janela.mainloop()